...
\algo{25}{Fast MIS 2}{50}
{
	\begin{items}
		...
		\item {\bf Theorem 5.11:} terminates after {\bt time} at most $3 log_{4/3} m +
...
\defi{5.16}
{
	An approximation algorithm A for a maximization problem Π has an approximation
	factor of $r$ if the following condition holds for all instances $I \in \Pi$:\\
